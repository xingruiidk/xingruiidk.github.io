...
function drawLives() {
    ...
    for (let i = 0; i < maxLives; i++) {
        ...
        ctx.drawImage(heartImage, heartX, 30, 30, 30); // Adjust size and position as needed
    }
}
...
function drawItems() {
  ...
  if (currentCustomer.image.complete && currentCustomer.image.naturalHeight !== 0) {
    ctx.drawImage(currentCustomer.image, 300, 68 + currentCustomer.heightOffset, currentCustomer.imageWidth, currentCustomer.imageHeight);
  } else {
